...
const TournamentListItemSkeleton = () => {
  return (
    <div
      className={cn(
        'flex w-full cursor-pointer items-center gap-4 rounded-lg border border-border bg-card p-4'
      )}
    >
      ...
      <div className='flex flex-shrink-0 items-center gap-4'>
        <div className='h-5 w-20 animate-pulse rounded-full bg-gray-300'></div>
